...
class Controller(object):
    ...
    def control(self, current_vel, dbw_enabled, linear_vel, angular_vel):
	    ...
	    '''
        current_vel = self.vel_lpf.filt(current_vel) # filtering the current velocity by using the lower pass to let car run smoothly
        steering = self.yaw_controller.get_steering(linear_vel, angular_vel, current_vel) # calculate stering
